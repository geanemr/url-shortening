  ...
  return (
    <>
      <form
        ...
        className="flex flex-col relative m-2 lg:m-0 p-8 lg:p-12 bg-no-repeat bg-right-top bg-primary-darkViolet bg-inputMobile lg:bg-inputDesktop rounded-md mb-6 lg:mb-12 mt-2"
      >
